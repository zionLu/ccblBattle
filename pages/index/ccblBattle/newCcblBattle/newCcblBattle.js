Page({
  ...
  onShareAppMessage: function () {
    ...
    submit:function(){
        let self = this
        if (this.data.addressName == "请点击选择地址" || this.data.addressDescription == '' || this.data.date == '请点击选择日期' || this.data.time =='请点击选择具体时间'){
            wx.showModal({
                title: '请正确填写信息',
                content: '',
                showCancel: false,
            ...
            wx.request({
                url: 'https://www.runhigh-ccbl.com/api/ccbl/postInvitation',
                header: { 'Authorization': 'Bearer ' + wx.getStorageSync('token') },
                data: {
                    matchTime: self.data.date+' '+self.data.time,
